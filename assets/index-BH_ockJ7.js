...
`,re={root:function(n){var e=n.props,o=n.instance;return["p-badge p-component",{"p-badge-circle":Ot(e.value)&&String(e.value).length===1,"p-badge-dot":pn(e.value)&&!o.$slots.default,"p-badge-sm":e.size==="small","p-badge-lg":e.size==="large","p-badge-xl":e.size==="xlarge","p-badge-info":e.severity==="info","p-badge-success":e.severity==="success","p-badge-warn":e.severity==="warn","p-badge-danger":e.severity==="danger","p-badge-secondary":e.severity==="secondary","p-badge-contrast":e.severity==="contrast"}]}},ie=Nt.extend({name:"badge",style:oe,classes:re}),se={name:"BaseBadge",extends:_t,props:{value:{type:[String,Number],default:null},severity:{type:String,default:null},size:{type:String,default:null}},style:ie,provide:function(){return{$pcBadge:this,$parentInstance:this}}};function Q(t){"@babel/helpers - typeof";return Q=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(n){return typeof n}:function(n){return n&&typeof Symbol=="function"&&n.constructor===Symbol&&n!==Symbol.prototype?"symbol":typeof n},Q(t)}function Kt(t,n,e){return(n=ae(n))in t?Object.defineProperty(t,n,{value:e,enumerable:!0,configurable:!0,writable:!0}):t[n]=e,t}function ae(t){var n=de(t,"string");return Q(n)=="symbol"?n:n+""}function de(t,n){if(Q(t)!="object"||!t)return t;var e=t[Symbol.toPrimitive];if(e!==void 0){var o=e.call(t,n);if(Q(o)!="object")return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return(n==="string"?String:Number)(t)}var gn={name:"Badge",extends:se,inheritAttrs:!1,computed:{dataP:function(){return G(Kt(Kt({circle:this.value!=null&&String(this.value).length===1,empty:this.value==null&&!this.$slots.default},this.severity,this.severity),this.size,this.size))}}},ue=["data-p"];function le(t,n,e,o,r,i){return B(),V("span",P({class:t.cx("root"),"data-p":i.dataP},t.ptmi("root")),[X(t.$slots,"default",{},function(){return[Mn(fn(t.value),1)]})],16,ue)}gn.render=le;var ce=`
    .p-button {
        display: inline-flex;
        cursor: pointer;
        user-select: none;
